...
public class AlunoNegocio {
    ...
    public AlunoNegocio() throws NegocioException {
        try {
            this.alunoDAO = new AlunoDAO(ConexaoBD.getInstance());
    ...
    public List<AlunoVO> retornaAlunos() throws NegocioException {
        try {
            return alunoDAO.printAlunos();
        } catch (PersistenciaException ex) {
    ...
    public List<AlunoDTO> retornaAlunosPorCurso(int codigo) throws NegocioException {
        try {
            return alunoDAO.printAlunosPorCurso(codigo);
        } catch (PersistenciaException ex) {
    ...
    private String validarDados(AlunoVO alunoVO) {
        ...
        if (alunoVO.getCurso().getCodigo() == null){
